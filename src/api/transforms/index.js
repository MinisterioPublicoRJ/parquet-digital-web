...
export { default as todayEntriesTransformPip } from './todayEntriesTransform';
export { default as todayOutliersTransformPip } from './todayOutliersTransform';
...
export const todayOutTransformPip = ({ percent_rank }) => percent_rank;
