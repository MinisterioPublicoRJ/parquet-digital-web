...
export const COMPRAS = ({ compId, contrato }) => ({
  ...
  background: '#F8BD6C',
  link: `https://tableau2020.mprj.mp.br/t/MPMAPAS/views/AnlisedeComprasv2_0-Alertas/ParquetDigital?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link:embed=yes&:toolbar=no&contratoiditem=${compId}`,
});
