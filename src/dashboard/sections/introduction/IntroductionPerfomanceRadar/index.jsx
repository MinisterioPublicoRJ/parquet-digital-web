...
function IntroductionPerfomanceRadar() {
  return (
    <div className="introduction-wrapper">
      ...
      <p>
        Será possível entender também como a sua Promotoria se coloca diante das Promotorias colegas
        de mesmas atribuição. É super simples e tentamos trazer para você uma visualização lúdica da
        sua atuação. Para saber mais sobre os termos e cálculos utilizados para compor estar
        visualização disponibilizamos uma explicação detalhada de cada item no Glossário.
      </p>
      <p>
