...
export const PROCESSES_LIST = t(`${BASE_URL}/lista/processos/\${orgao}?page=1`);
export const ONGOING_INVESTIGATIONS_LIST = t(`${BASE_URL}/lista/investigacoes/\${orgao}?page=1`);
